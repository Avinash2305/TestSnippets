...
ENCRYPTED_PASSWORD_FOR_RMI=/Users/venkat-0773/del/ciena/encrypted_password_for_fe_startup

#Please do not edit this entry, it will be used by the DeploymentWizard tool
CUSTOMPATH=

#RADIUS=/Volumes/Official/venkat/kbase/radius_webnms_simultaneous_authentication/worked_for_ciena_3133134/dual_authentication/temp
SNMPV3_AUTHUSER=/Users/venkat-0773/del/ciena/v2c_v3/debug
CLASSPATH=$SNMPV3_AUTHUSER:$NMS_ARC:$SNMP_CLASSPATH:$XML_CLASSPATH:$JIMI_CLASSPATH:$BUILDER_CLASSPATH:$TL1_CLASSPATH:$MS_CLIENT_CLASSPATH:$CLI_CLIENT_CLASSPATH:$CUSTOMPATH:$NARPATH:$NMS_HOME/classes/AdventNetSnmpV3USM.jar:$NMS_CLASSES/ClientExamples.jar:$NMS_CLASSES/AdventNetAboutDialog.jar:$NMS_CLASSES/jnlp.jar:$NMS_CLASSES/AdventNetCCLLibrary.jar:$NMS_CLASSES/AdventNetProBeans.jar:$NMS_CLASSES/Mail.jar:$NMS_CLASSES/json.jar:$NMS_CLASSES/AdventNetDMPModels.jar:$NMS_CLASSES/AdventNetNPrevalent.jar:$NMS_CLASSES/AdventNetUpdateManagerInstaller.jar:$SUM_CLIENT_CLASSPATH
export CLASSPATH
...
while(true)
do
$JAVA_HOME/bin/java -Xmx200m -XX:+HeapDumpOnOutOfMemoryError -Dcom.sun.management.jmxremote.port=14000 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.snmp.interface=`hostname` -Dcom.sun.management.snmp.acl=false -Dcom.sun.management.snmp.port=14500 com.adventnet.nms.startclient.WebNMSClient $host 9090 CRYPTO_CLASS=com.adventnet.security.authentication.RadiusEncryption 
