<%-- $Id: PollGraphs.jsp,v 1.1 2007/06/14 13:56:57 venkatramanan Exp $ --%>
<HTML>
<HEAD>

<TITLE><%= NmsUtil.GetString("Poll Graphs") %></TITLE>
...
<center>
<A HREF="javascript:history.back()" OnMouseOut="window.status=''; return true" OnMouseOver="window.status='<%= NmsUtil.GetString("Go Back to Previous") %>'; return true"><IMG SRC="../images/back.png" ALT="<%= NmsUtil.GetString("Back") %>" BORDER="0"></A>
</BODY>
</HTML>
<%!
